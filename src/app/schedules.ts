...
export const SCHEDULES: Schedule[] = [
  ...
  { id: 4, channelName: 'noopkat', dayOfWeek: 2, timeOfDay: 13, timezone: 'EST' }, // Tuesday 13:00
  { id: 5, channelName: 'noopkat', dayOfWeek: 7, timeOfDay: 11, timezone: 'EST' }, // Sunday 11:00
];